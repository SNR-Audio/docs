...
<CardGroup cols={2}>
  ...
  <Card title="Join Our Community" icon="comments" href="https://community.snr.audio">
...
Once you have set up your account, we will move on to [Speech to Text](/endpoint/convert-speech-to-text.mdx). Here, you will be able to transcribe audio inputs into text outputs using our API.
